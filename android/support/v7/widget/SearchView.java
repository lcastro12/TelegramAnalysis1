...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    class C00834 implements OnFocusChangeListener {
        C00834() {
        }
    ...
    class C00845 implements OnLayoutChangeListener {
        C00845() {
        }
    ...
    class C00856 implements OnGlobalLayoutListener {
        C00856() {
        }
    ...
    class C00867 implements OnClickListener {
        C00867() {
        }
    ...
    class C00878 implements OnKeyListener {
        C00878() {
        }
    ...
    class C00889 implements OnEditorActionListener {
        C00889() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mShowImeRunnable = new C00801();
        this.mUpdateDrawableStateRunnable = new C00812();
        this.mReleaseCursorRunnable = new C00823();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C00867();
        this.mTextKeyListener = new C00878();
        this.mOnEditorActionListener = new C00889();
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0059R.layout.abc_search_view, this, true);
        this.mSearchButton = findViewById(C0059R.id.search_button);
        this.mQueryTextView = (SearchAutoComplete) findViewById(C0059R.id.search_src_text);
        this.mQueryTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0059R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0059R.id.search_plate);
        this.mSubmitArea = findViewById(C0059R.id.submit_area);
        this.mSubmitButton = findViewById(C0059R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0059R.id.search_close_btn);
        this.mVoiceButton = findViewById(C0059R.id.search_voice_btn);
        this.mSearchHintIcon = (ImageView) findViewById(C0059R.id.search_mag_icon);
        ...
        this.mQueryTextView.setOnFocusChangeListener(new C00834());
        TypedArray a = context.obtainStyledAttributes(attrs, C0059R.styleable.SearchView, 0, 0);
        ...
        a.recycle();
        a = context.obtainStyledAttributes(attrs, C0059R.styleable.View, 0, 0);
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C00845());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C00856());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0059R.dimen.abc_search_view_preferred_width);
    }
    ...
    private int getSearchIconId() {
        ...
        getContext().getTheme().resolveAttribute(C0059R.attr.searchViewSearchIcon, outValue, true);
    ...
    private void updateQueryHint() {
        if (this.mQueryHint != null) {
            ...
            this.mQueryTextView.setHint(getDecoratedHint(BuildConfig.FLAVOR));
        }
    }
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0059R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0059R.dimen.abc_dropdownitem_text_padding_left) : 0;
