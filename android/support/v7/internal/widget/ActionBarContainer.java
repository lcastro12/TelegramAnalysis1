...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0059R.styleable.ActionBar);
        this.mBackground = a.getDrawable(10);
        this.mStackedBackground = a.getDrawable(11);
        if (getId() == C0059R.id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = (ActionBarView) findViewById(C0059R.id.action_bar);
    }
