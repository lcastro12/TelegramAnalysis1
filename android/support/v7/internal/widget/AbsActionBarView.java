...
abstract class AbsActionBarView extends ViewGroup {
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C0059R.styleable.ActionBar, C0059R.attr.actionBarStyle, 0);
        setContentHeight(a.getLayoutDimension(0, 0));
        a.recycle();
        if (this.mSplitWhenNarrow) {
            setSplitActionBar(getContext().getResources().getBoolean(C0059R.bool.abc_split_action_bar_is_narrow));
        }
    ...
    public void animateToVisibility(int visibility) {
        ...
        if (visibility != getVisibility()) {
            Animation anim = AnimationUtils.loadAnimation(getContext(), visibility == 0 ? C0059R.anim.abc_fade_in : C0059R.anim.abc_fade_out);
            startAnimation(anim);
