...
public class ActionBarOverlayLayout extends FrameLayout {
    static final int[] mActionBarSizeAttr = new int[]{C0059R.attr.actionBarSize};
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = findViewById(C0059R.id.action_bar_activity_content);
            if (this.mContent == null) {
                this.mContent = findViewById(16908290);
            }
            this.mActionBarTop = findViewById(C0059R.id.top_action_bar);
            this.mContainerView = (ActionBarContainer) findViewById(C0059R.id.action_bar_container);
            this.mActionView = (ActionBarView) findViewById(C0059R.id.action_bar);
            this.mActionBarBottom = findViewById(C0059R.id.split_action_bar);
        }
    }
}
