...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemClickListener {
    ...
    private LinearLayout mTabLayout = ((LinearLayout) this.mInflater.inflate(C0059R.layout.abc_action_bar_tabbar, this, false));
    ...
    public static class TabView extends LinearLayout {
        ...
        public void update() {
            ...
            if (text != null) {
                if (this.mTextView == null) {
                    TextView textView = new CompatTextView(getContext(), null, C0059R.attr.actionBarTabTextStyle);
    ...
    private SpinnerICS createSpinner() {
        SpinnerICS spinner = new SpinnerICS(getContext(), null, C0059R.attr.actionDropDownStyle);
    ...
    private TabView createTabView(Tab tab, boolean forAdapter) {
        TabView tabView = (TabView) this.mInflater.inflate(C0059R.layout.abc_action_bar_tab, this.mTabLayout, false);
