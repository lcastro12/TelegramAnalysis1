...
public class ActionMenuPresenter extends BaseMenuPresenter implements SubUiVisibilityListener {
    ...
    private class OverflowMenuButton extends ImageButton implements ActionMenuChildView {
        public OverflowMenuButton(Context context) {
            super(context, null, C0059R.attr.actionOverflowButtonStyle);
            setClickable(true);
            setFocusable(true);
            setVisibility(0);
            setEnabled(true);
    ...
    public ActionMenuPresenter(Context context) {
        super(context, C0059R.layout.abc_action_menu_layout, C0059R.layout.abc_action_menu_item_layout);
    }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        if (!this.mMaxItemsSet) {
            this.mMaxItems = this.mContext.getResources().getInteger(C0059R.integer.abc_max_action_buttons);
        }
        if (this.mMenu != null) {
