...
class ActionBarImplBase extends ActionBar {
    ...
    private void init(ActionBarActivity activity) {
        boolean z = false;
        this.mOverlayLayout = (ActionBarOverlayLayout) activity.findViewById(C0059R.id.action_bar_overlay_layout);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBar(this);
        }
        this.mActionView = (ActionBarView) activity.findViewById(C0059R.id.action_bar);
        this.mContextView = (ActionBarContextView) activity.findViewById(C0059R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) activity.findViewById(C0059R.id.action_bar_container);
        this.mTopVisibilityView = (ViewGroup) activity.findViewById(C0059R.id.top_action_bar);
        if (this.mTopVisibilityView == null) {
            this.mTopVisibilityView = this.mContainerView;
        }
        this.mSplitView = (ActionBarContainer) activity.findViewById(C0059R.id.split_action_bar);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0059R.attr.actionBarWidgetTheme, outValue, true);
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mTopVisibilityView.getVisibility() != 0) {
            ...
            if (animate) {
                this.mTopVisibilityView.startAnimation(AnimationUtils.loadAnimation(this.mContext, C0059R.anim.abc_slide_in_top));
            }
            this.mTopVisibilityView.setVisibility(0);
            if (this.mSplitView != null && this.mSplitView.getVisibility() != 0) {
                if (animate) {
                    this.mSplitView.startAnimation(AnimationUtils.loadAnimation(this.mContext, C0059R.anim.abc_slide_in_bottom));
                }
                this.mSplitView.setVisibility(0);
            }
        }
    ...
    public void doHide(boolean fromSystem) {
        ...
        if (this.mTopVisibilityView.getVisibility() != 8) {
            ...
            if (animate) {
                this.mTopVisibilityView.startAnimation(AnimationUtils.loadAnimation(this.mContext, C0059R.anim.abc_slide_out_top));
            }
            this.mTopVisibilityView.setVisibility(8);
            if (this.mSplitView != null && this.mSplitView.getVisibility() != 8) {
                if (animate) {
                    this.mSplitView.startAnimation(AnimationUtils.loadAnimation(this.mContext, C0059R.anim.abc_slide_out_bottom));
                }
