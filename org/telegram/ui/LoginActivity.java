...
public class LoginActivity extends BaseFragment {
    ...
    public class LoginActivityPasswordView extends SlideView {
        ...
        class C19274 implements RequestDelegate {
            C19274() {
            }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        if (error == null) {
                            ...
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.formatString("FloodWaitTime", C0488R.string.FloodWaitTime, timeString));
                        } else {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), error.text);
                        }
                    }
                });
            }
        ...
        class C19285 implements Runnable {
            C19285() {
            }
        ...
        public LoginActivityPasswordView(Context context) {
            ...
            this.confirmTextView.setText(LocaleController.getString("LoginPasswordText", C0488R.string.LoginPasswordText));
            ...
            this.codeField.setHint(LocaleController.getString("LoginPassword", C0488R.string.LoginPassword));
            ...
            this.cancelButton.setText(LocaleController.getString("ForgotPassword", C0488R.string.ForgotPassword));
            ...
            this.cancelButton.setOnClickListener(new OnClickListener(LoginActivity.this) {
                ...
                class C19201 implements RequestDelegate {
                    C19201() {
                    }
                        ...
                        AndroidUtilities.runOnUIThread(new Runnable() {
                            public void run() {
                                ...
                                if (error == null) {
                                    ...
                                    builder.setMessage(LocaleController.formatString("RestoreEmailSent", C0488R.string.RestoreEmailSent, res.email_pattern));
                ...
                public void onClick(View view) {
                    if (LoginActivityPasswordView.this.has_recovery) {
                        ...
                        ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(new TL_auth_requestPasswordRecovery(), new C19201(), 10);
                        return;
                    }
                    ...
                    LoginActivity.this.needShowAlert(LocaleController.getString("RestorePasswordNoEmailTitle", C0488R.string.RestorePasswordNoEmailTitle), LocaleController.getString("RestorePasswordNoEmailText", C0488R.string.RestorePasswordNoEmailText));
                }
            });
            ...
            this.resetAccountButton.setText(LocaleController.getString("ResetMyAccount", C0488R.string.ResetMyAccount));
            ...
            this.resetAccountButton.setOnClickListener(new OnClickListener(LoginActivity.this) {
                ...
                class C19241 implements DialogInterface.OnClickListener {
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    ...
                                    if (error == null) {
                                        ...
                                        LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("ResetAccountCancelledAlert", C0488R.string.ResetAccountCancelledAlert));
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new C19231(), 10);
                    }
                }

                public void onClick(View view) {
                    Builder builder = new Builder(LoginActivity.this.getParentActivity());
                    builder.setMessage(LocaleController.getString("ResetMyAccountWarningText", C0488R.string.ResetMyAccountWarningText));
                    builder.setTitle(LocaleController.getString("ResetMyAccountWarning", C0488R.string.ResetMyAccountWarning));
                    builder.setPositiveButton(LocaleController.getString("ResetMyAccountWarningReset", C0488R.string.ResetMyAccountWarningReset), new C19241());
            ...
            this.resetAccountText.setText(LocaleController.getString("ResetMyAccountText", C0488R.string.ResetMyAccountText));
        ...
        public String getHeaderName() {
            return LocaleController.getString("LoginPassword", C0488R.string.LoginPassword);
        }
        ...
        public void onNextPressed() {
            if (!this.nextPressed) {
                ...
                try {
                    oldPasswordBytes = oldPassword.getBytes(C0600C.UTF8_NAME);
                } catch (Throwable e) {
                    FileLog.m3e(e);
                }
                LoginActivity.this.needShowProgress(0);
                ...
                ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new C19274(), 10);
            }
        }
        ...
        public void onShow() {
            super.onShow();
            AndroidUtilities.runOnUIThread(new C19285(), 100);
        }
    ...
    public class LoginActivityRecoverView extends SlideView {
        ...
        class C19333 implements RequestDelegate {
            C19333() {
            }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        if (error == null) {
                            ...
                            LoginActivityRecoverView.this.this$0.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.formatString("FloodWaitTime", C0488R.string.FloodWaitTime, timeString));
                        } else {
                            LoginActivityRecoverView.this.this$0.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), error.text);
                        }
                    }
                });
            }
        ...
        class C19344 implements Runnable {
            C19344() {
            }
        ...
        public LoginActivityRecoverView(final LoginActivity this$0, Context context) {
            ...
            this.confirmTextView.setGravity(LocaleController.isRTL ? 5 : 3);
            this.confirmTextView.setLineSpacing((float) AndroidUtilities.dp(2.0f), 1.0f);
            this.confirmTextView.setText(LocaleController.getString("RestoreEmailSentInfo", C0488R.string.RestoreEmailSentInfo));
            ...
            this.codeField.setHintTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteHintText));
            this.codeField.setBackgroundDrawable(Theme.createEditTextDrawable(context, false));
            this.codeField.setHint(LocaleController.getString("PasswordCode", C0488R.string.PasswordCode));
            this.codeField.setImeOptions(268435461);
            this.codeField.setTextSize(1, 18.0f);
            this.codeField.setMaxLines(1);
            this.codeField.setPadding(0, 0, 0, 0);
            ...
            this.cancelButton.setOnClickListener(new OnClickListener() {
                ...
                class C19301 implements DialogInterface.OnClickListener {
                    C19301() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    builder.setMessage(LocaleController.getString("RestoreEmailTroubleText", C0488R.string.RestoreEmailTroubleText));
                    builder.setTitle(LocaleController.getString("RestorePasswordNoEmailTitle", C0488R.string.RestorePasswordNoEmailTitle));
                    builder.setPositiveButton(LocaleController.getString("OK", C0488R.string.OK), new C19301());
        ...
        public void setParams(Bundle params, boolean restore) {
            if (params != null) {
                ...
                this.currentParams = params;
                this.email_unconfirmed_pattern = this.currentParams.getString("email_unconfirmed_pattern");
                this.cancelButton.setText(LocaleController.formatString("RestoreEmailTrouble", C0488R.string.RestoreEmailTrouble, this.email_unconfirmed_pattern));
        ...
        public void onNextPressed() {
            if (!this.nextPressed) {
                ...
                req.code = code;
                ConnectionsManager.getInstance(this.this$0.currentAccount).sendRequest(req, new C19333(), 10);
            }
        }
        ...
        public void onShow() {
            super.onShow();
            AndroidUtilities.runOnUIThread(new C19344(), 100);
        }
    ...
    public class LoginActivityRegisterView extends SlideView {
        ...
        class C19394 implements Runnable {
            C19394() {
            }
        ...
        class C19415 implements RequestDelegate {
            C19415() {
            }
                ...
                AndroidUtilities.runOnUIThread(new Runnable() {
                    public void run() {
                        ...
                        if (error == null) {
                            ...
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("InvalidPhoneNumber", C0488R.string.InvalidPhoneNumber));
                        } else if (error.text.contains("PHONE_CODE_EMPTY") || error.text.contains("PHONE_CODE_INVALID")) {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("InvalidCode", C0488R.string.InvalidCode));
                        } else if (error.text.contains("PHONE_CODE_EXPIRED")) {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("CodeExpired", C0488R.string.CodeExpired));
                        } else if (error.text.contains("FIRSTNAME_INVALID")) {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("InvalidFirstName", C0488R.string.InvalidFirstName));
                        } else if (error.text.contains("LASTNAME_INVALID")) {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("InvalidLastName", C0488R.string.InvalidLastName));
                        } else {
                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), error.text);
                        }
                    }
        ...
        public LoginActivityRegisterView(Context context) {
            ...
            this.textView.setText(LocaleController.getString("RegisterText", C0488R.string.RegisterText));
            ...
            this.wrongNumber.setText(LocaleController.getString("CancelRegistration", C0488R.string.CancelRegistration));
            ...
            this.wrongNumber.setOnClickListener(new OnClickListener(LoginActivity.this) {
                ...
                class C19371 implements DialogInterface.OnClickListener {
                    C19371() {
                    }
                ...
                public void onClick(View view) {
                    Builder builder = new Builder(LoginActivity.this.getParentActivity());
                    builder.setTitle(LocaleController.getString("AppName", C0488R.string.AppName));
                    builder.setMessage(LocaleController.getString("AreYouSureRegistration", C0488R.string.AreYouSureRegistration));
                    builder.setPositiveButton(LocaleController.getString("OK", C0488R.string.OK), new C19371());
                    builder.setNegativeButton(LocaleController.getString("Cancel", C0488R.string.Cancel), null);
                    LoginActivity.this.showDialog(builder.create());
                }
            });
        ...
        public String getHeaderName() {
            return LocaleController.getString("YourName", C0488R.string.YourName);
        }
        ...
        public void onShow() {
            super.onShow();
            AndroidUtilities.runOnUIThread(new C19394(), 100);
        }
        ...
        public void onNextPressed() {
            if (!this.nextPressed) {
                ...
                LoginActivity.this.needShowProgress(0);
                ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new C19415(), 10);
            }
        }
    ...
    public class LoginActivityResetWaitView extends SlideView {
        ...
        class C19462 implements Runnable {
            C19462() {
            }
        ...
        public LoginActivityResetWaitView(final LoginActivity this$0, Context context) {
            ...
            this.resetAccountText.setTextColor(Theme.getColor(Theme.key_windowBackgroundWhiteGrayText6));
            this.resetAccountText.setText(LocaleController.getString("ResetAccountStatus", C0488R.string.ResetAccountStatus));
            this.resetAccountText.setTextSize(1, 14.0f);
            this.resetAccountText.setLineSpacing((float) AndroidUtilities.dp(2.0f), 1.0f);
            ...
            textView.setGravity(i | 48);
            this.resetAccountButton.setText(LocaleController.getString("ResetAccountButton", C0488R.string.ResetAccountButton));
            this.resetAccountButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
            this.resetAccountButton.setTextSize(1, 14.0f);
            this.resetAccountButton.setLineSpacing((float) AndroidUtilities.dp(2.0f), 1.0f);
            this.resetAccountButton.setPadding(0, AndroidUtilities.dp(14.0f), 0, 0);
            ...
            this.resetAccountButton.setOnClickListener(new OnClickListener() {
                ...
                class C19441 implements DialogInterface.OnClickListener {
                            ...
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    ...
                                    if (error == null) {
                                        ...
                                        LoginActivityResetWaitView.this.this$0.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("ResetAccountCancelledAlert", C0488R.string.ResetAccountCancelledAlert));
                                    } else {
                                        LoginActivityResetWaitView.this.this$0.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), error.text);
                                    }
                                }
                            });
                        }
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        TL_account_deleteAccount req = new TL_account_deleteAccount();
                        req.reason = "Forgot password";
                        ConnectionsManager.getInstance(LoginActivityResetWaitView.this.this$0.currentAccount).sendRequest(req, new C19431(), 10);
                    }
                }
                ...
                public void onClick(View view) {
                    if (Math.abs(ConnectionsManager.getInstance(LoginActivityResetWaitView.this.this$0.currentAccount).getCurrentTime() - LoginActivityResetWaitView.this.startTime) >= LoginActivityResetWaitView.this.waitTime) {
                        ...
                        builder.setMessage(LocaleController.getString("ResetMyAccountWarningText", C0488R.string.ResetMyAccountWarningText));
                        builder.setTitle(LocaleController.getString("ResetMyAccountWarning", C0488R.string.ResetMyAccountWarning));
                        builder.setPositiveButton(LocaleController.getString("ResetMyAccountWarningReset", C0488R.string.ResetMyAccountWarningReset), new C19441());
                        builder.setNegativeButton(LocaleController.getString("Cancel", C0488R.string.Cancel), null);
        ...
        public String getHeaderName() {
            return LocaleController.getString("ResetAccount", C0488R.string.ResetAccount);
        }
        ...
        public void setParams(Bundle params, boolean restore) {
            if (params != null) {
                ...
                this.confirmTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("ResetAccountInfo", C0488R.string.ResetAccountInfo, LocaleController.addNbsp(PhoneFormat.getInstance().format("+" + this.requestPhone)))));
                updateTimeText();
                this.timeRunnable = new C19462();
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenterDelegate {
        ...
        class C19556 extends TimerTask {
            ...
            public void run() {
                ...
                AndroidUtilities.runOnUIThread(new C19541());
            }
        }

        class C19597 extends TimerTask {
                ...
                public void run() {
                    ...
                    if (LoginActivitySmsView.this.currentType == 3) {
                        ...
                        if (LoginActivitySmsView.this.nextType == 4) {
                            ...
                            ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new C19571(), 10);
            ...
            public void run() {
                if (LoginActivitySmsView.this.timeTimer != null) {
                    ...
                    AndroidUtilities.runOnUIThread(new C19581());
                }
            }
        }

        class C19649 implements Runnable {
            C19649() {
            }
        ...
        public LoginActivitySmsView(Context context, int type) {
                    ...
                    if (!LoginActivitySmsView.this.nextPressed) {
                        if (LoginActivitySmsView.this.nextType == 0 || LoginActivitySmsView.this.nextType == 4) {
                            try {
                                ...
                                LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("NoMailInstalled", C0488R.string.NoMailInstalled));
                                return;
                            }
                        }
                        LoginActivitySmsView.this.resendCode();
            ...
            this.wrongNumber.setOnClickListener(new OnClickListener(LoginActivity.this) {
                ...
                class C19501 implements RequestDelegate {
                    C19501() {
                    }
                ...
                public void onClick(View view) {
                    ...
                    req.phone_number = LoginActivitySmsView.this.requestPhone;
                    req.phone_code_hash = LoginActivitySmsView.this.phoneHash;
                    ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new C19501(), 10);
        ...
        private void resendCode() {
            ...
            req.phone_number = this.requestPhone;
            req.phone_code_hash = this.phoneHash;
            int reqId = ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new RequestDelegate() {
                public void run(final TLObject response, final TL_error error) {
                    AndroidUtilities.runOnUIThread(new Runnable() {
                        public void run() {
                            ...
                            if (error == null) {
                                ...
                                if (error.text.contains("PHONE_NUMBER_INVALID")) {
                                    ...
                                    LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("FloodWait", C0488R.string.FloodWait));
                                } else if (error.code != C0600C.PRIORITY_DOWNLOAD) {
                                    LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("ErrorOccurred", C0488R.string.ErrorOccurred) + "\n" + error.text);
                                }
                            }
                            LoginActivity.this.needHideProgress();
                        }
        ...
        private void createCodeTimer() {
            if (this.codeTimer == null) {
                ...
                this.codeTimer.schedule(new C19556(), 0, 1000);
            }
        }
        ...
        private void createTimer() {
            if (this.timeTimer == null) {
                ...
                this.timeTimer.schedule(new C19597(), 0, 1000);
            }
        }
                            ...
                            public void run() {
                                ...
                                if (error == null) {
                                    ...
                                    if (error.text.contains("PHONE_NUMBER_UNOCCUPIED")) {
                                        ...
                                        ok = true;
                                        ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(new TL_account_getPassword(), new C19611(), 10);
                                        LoginActivitySmsView.this.destroyTimer();
                                        LoginActivitySmsView.this.destroyCodeTimer();
                                    } else {
                                        LoginActivity.this.needHideProgress();
        ...
        public void onShow() {
            super.onShow();
            if (this.currentType != 3) {
                AndroidUtilities.runOnUIThread(new C19649(), 100);
            }
        }
    ...
    public class PhoneView extends SlideView implements OnItemSelectedListener {
        ...
        public PhoneView(Context context) {
            ...
            this.countryButton.setOnClickListener(new OnClickListener() {
                ...
                class C19661 implements CountrySelectActivityDelegate {

                    class C19651 implements Runnable {
                        C19651() {
                        }
                    ...
                    public void didSelectCountry(String name, String shortName) {
                        ...
                        AndroidUtilities.runOnUIThread(new C19651(), 300);
                ...
                public void onClick(View view) {
                    ...
                    fragment.setCountrySelectActivityDelegate(new C19661());
            ...
            this.textView2.setText(LocaleController.getString("StartText", C0488R.string.StartText));
            ...
            if (LoginActivity.this.newAccount) {
                ...
                this.checkBoxCell.setText(LocaleController.getString("SyncContacts", C0488R.string.SyncContacts), TtmlNode.ANONYMOUS_REGION_ID, LoginActivity.this.syncContacts, false);
                    ...
                    public void onClick(View v) {
                        if (LoginActivity.this.getParentActivity() != null) {
                            ...
                            if (LoginActivity.this.syncContacts) {
                                this.visibleToast = Toast.makeText(LoginActivity.this.getParentActivity(), LocaleController.getString("SyncContactsOn", C0488R.string.SyncContactsOn), 0);
                                this.visibleToast.show();
                                return;
                            }
                            this.visibleToast = Toast.makeText(LoginActivity.this.getParentActivity(), LocaleController.getString("SyncContactsOff", C0488R.string.SyncContactsOff), 0);
                            this.visibleToast.show();
                        }
                    }
                });
        ...
        public void onNextPressed() {
            if (LoginActivity.this.getParentActivity() != null && !this.nextPressed) {
                ...
                if (this.countryState == 1) {
                    LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("ChooseCountry", C0488R.string.ChooseCountry));
                    ...
                    for (int a = 0; a < 3; a++) {
                        ...
                        if (userConfig.isClientActivated()) {
                            ...
                            if (userPhone.contains(phone) || phone.contains(userPhone)) {
                                ...
                                builder = new Builder(LoginActivity.this.getParentActivity());
                                builder.setTitle(LocaleController.getString("AppName", C0488R.string.AppName));
                                builder.setMessage(LocaleController.getString("AccountAlreadyLoggedIn", C0488R.string.AccountAlreadyLoggedIn));
                                builder.setPositiveButton(LocaleController.getString("AccountSwitch", C0488R.string.AccountSwitch), new DialogInterface.OnClickListener() {
                    ...
                    LoginActivity.this.needShowProgress(ConnectionsManager.getInstance(LoginActivity.this.currentAccount).sendRequest(req, new RequestDelegate() {
                        public void run(final TLObject response, final TL_error error) {
                            AndroidUtilities.runOnUIThread(new Runnable() {
                                public void run() {
                                    ...
                                    if (error == null) {
                                        ...
                                        if (error.text.contains("PHONE_NUMBER_INVALID")) {
                                            ...
                                            LoginActivity.this.needShowAlert(LocaleController.getString("AppName", C0488R.string.AppName), LocaleController.getString("PhoneNumberFlood", C0488R.string.PhoneNumberFlood));
                        ...
                        if (!(!LoginActivity.this.checkShowPermissions || allowCall || allowSms)) {
                            ...
                            if (!LoginActivity.this.permissionsShowItems.isEmpty()) {
                                ...
                                if (preferences.getBoolean("firstloginshow", true) || LoginActivity.this.getParentActivity().shouldShowRequestPermissionRationale("android.permission.READ_PHONE_STATE") || LoginActivity.this.getParentActivity().shouldShowRequestPermissionRationale("android.permission.RECEIVE_SMS")) {
                                    ...
                                    builder.setTitle(LocaleController.getString("AppName", C0488R.string.AppName));
                                    builder.setPositiveButton(LocaleController.getString("OK", C0488R.string.OK), null);
                                    builder.setMessage(LocaleController.getString("AllowFillNumber", C0488R.string.AllowFillNumber));
        ...
        public String getHeaderName() {
            return LocaleController.getString("YourPhone", C0488R.string.YourPhone);
        }
    ...
    public View createView(Context context) {
        ...
        this.doneButton = menu.addItemWithWidth(1, C0488R.drawable.ic_done, AndroidUtilities.dp(56.0f));
        ...
        while (a < this.views.length) {
            ...
            if (this.currentViewNum == a) {
                ...
                int i = (this.views[a].needBackButton() || this.newAccount) ? C0488R.drawable.ic_ab_back : 0;
    ...
    private void needShowInvalidAlert(final String phoneNumber, final boolean banned) {
        if (getParentActivity() != null) {
            ...
            builder.setTitle(LocaleController.getString("AppName", C0488R.string.AppName));
            if (banned) {
                builder.setMessage(LocaleController.getString("BannedPhoneNumber", C0488R.string.BannedPhoneNumber));
            } else {
                builder.setMessage(LocaleController.getString("InvalidPhoneNumber", C0488R.string.InvalidPhoneNumber));
            }
            builder.setNeutralButton(LocaleController.getString("BotHelp", C0488R.string.BotHelp), new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int which) {
                    try {
                        PackageInfo pInfo = ApplicationLoader.applicationContext.getPackageManager().getPackageInfo(ApplicationLoader.applicationContext.getPackageName(), 0);
                        String version = String.format(Locale.US, "%s (%d)", new Object[]{pInfo.versionName, Integer.valueOf(pInfo.versionCode)});
    ...
    private void needShowProgress(final int reqiestId) {
        if (getParentActivity() != null && !getParentActivity().isFinishing() && this.progressDialog == null) {
            ...
            builder.setMessage(LocaleController.getString("Loading", C0488R.string.Loading));
            if (reqiestId != 0) {
                builder.setPositiveButton(LocaleController.getString("Cancel", C0488R.string.Cancel), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
    ...
    public void setPage(int page, boolean animated, Bundle params, boolean back) {
        int i = C0488R.drawable.ic_ab_back;
        if (page == 3 || page == 8) {
            this.doneButton.setVisibility(8);
        } else {
            if (page == 0) {
