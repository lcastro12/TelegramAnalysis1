...
public class StickerCell extends FrameLayout {
    ...
    public void setSticker(Document document, int side) {
        ...
        if (side == -1) {
            setBackgroundResource(C0488R.drawable.stickers_back_left);
            setPadding(AndroidUtilities.dp(7.0f), 0, 0, 0);
        } else if (side == 0) {
            setBackgroundResource(C0488R.drawable.stickers_back_center);
            setPadding(0, 0, 0, 0);
        } else if (side == 1) {
            setBackgroundResource(C0488R.drawable.stickers_back_right);
            setPadding(0, 0, AndroidUtilities.dp(7.0f), 0);
        } else if (side == 2) {
            setBackgroundResource(C0488R.drawable.stickers_back_all);
