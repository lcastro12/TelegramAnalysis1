...
public class Theme {
    ...
    private static Runnable switchDayBrightnessRunnable = new C08861();
    private static boolean switchDayRunnableScheduled;
    private static Runnable switchNightBrightnessRunnable = new C08872();
    ...
    static class C08861 implements Runnable {
        C08861() {
        }
    ...
    static class C08872 implements Runnable {
        C08872() {
        }
    ...
    static class C08883 implements Runnable {
        C08883() {
        }
    ...
    static class C08894 extends StateListDrawable {
        C08894() {
        }
    ...
    static class C08905 extends StateListDrawable {
        C08905() {
        }
    ...
    static class C08916 extends StateListDrawable {
        C08916() {
        }
    ...
    static class C08927 extends Drawable {
        C08927() {
        }
    ...
    static class C08938 implements Comparator<ThemeInfo> {
        C08938() {
        }
    ...
    public static class ThemeInfo {
        ...
        public String getName() {
            if ("Default".equals(this.name)) {
                return LocaleController.getString("Default", C0488R.string.Default);
            }
            if ("Blue".equals(this.name)) {
                return LocaleController.getString("ThemeBlue", C0488R.string.ThemeBlue);
            }
            if ("Dark".equals(this.name)) {
                return LocaleController.getString("ThemeDark", C0488R.string.ThemeDark);
            }
            return this.name;
        }
    ...
    static {
        ...
        AndroidUtilities.runOnUIThread(new C08883());
    }
    ...
    public static Drawable createEmojiIconSelectorDrawable(Context context, int resource, int defaultColor, int pressedColor) {
        ...
        StateListDrawable stateListDrawable = new C08894();
    ...
    public static Drawable createEditTextDrawable(Context context, boolean alert) {
        Resources resources = context.getResources();
        Drawable defaultDrawable = resources.getDrawable(C0488R.drawable.search_dark).mutate();
        ...
        Drawable pressedDrawable = resources.getDrawable(C0488R.drawable.search_dark_activated).mutate();
        ...
        StateListDrawable stateListDrawable = new C08905();
    ...
    public static Drawable createSimpleSelectorDrawable(Context context, int resource, int defaultColor, int pressedColor) {
        ...
        StateListDrawable stateListDrawable = new C08916();
    ...
    private static void sortThemes() {
        Collections.sort(themes, new C08938());
    }
    ...
    public static void createCommonResources(Context context) {
        if (dividerPaint == null) {
            ...
            Resources resources = context.getResources();
            avatar_broadcastDrawable = resources.getDrawable(C0488R.drawable.broadcast_w);
            avatar_savedDrawable = resources.getDrawable(C0488R.drawable.bookmark_large);
            avatar_photoDrawable = resources.getDrawable(C0488R.drawable.photo_w);
            applyCommonTheme();
        }
    }
    ...
    public static void createDialogsResources(Context context) {
        ...
        if (dialogs_namePaint == null) {
            ...
            dialogs_lockDrawable = resources.getDrawable(C0488R.drawable.list_secret);
            dialogs_checkDrawable = resources.getDrawable(C0488R.drawable.list_check);
            dialogs_halfCheckDrawable = resources.getDrawable(C0488R.drawable.list_halfcheck);
            dialogs_clockDrawable = resources.getDrawable(C0488R.drawable.msg_clock).mutate();
            dialogs_errorDrawable = resources.getDrawable(C0488R.drawable.list_warning_sign);
            dialogs_groupDrawable = resources.getDrawable(C0488R.drawable.list_group);
            dialogs_broadcastDrawable = resources.getDrawable(C0488R.drawable.list_broadcast);
            dialogs_muteDrawable = resources.getDrawable(C0488R.drawable.list_mute).mutate();
            dialogs_verifiedDrawable = resources.getDrawable(C0488R.drawable.verified_area);
            dialogs_verifiedCheckDrawable = resources.getDrawable(C0488R.drawable.verified_check);
            dialogs_mentionDrawable = resources.getDrawable(C0488R.drawable.mentionchatslist);
            dialogs_botDrawable = resources.getDrawable(C0488R.drawable.list_bot);
            dialogs_pinnedDrawable = resources.getDrawable(C0488R.drawable.list_pin);
            applyDialogsTheme();
        }
    ...
    public static void createChatResources(Context context, boolean fontsOnly) {
        ...
        if (!fontsOnly && chat_msgInDrawable == null) {
            ...
            Resources resources = context.getResources();
            chat_msgInDrawable = resources.getDrawable(C0488R.drawable.msg_in).mutate();
            chat_msgInSelectedDrawable = resources.getDrawable(C0488R.drawable.msg_in).mutate();
            chat_msgOutDrawable = resources.getDrawable(C0488R.drawable.msg_out).mutate();
            chat_msgOutSelectedDrawable = resources.getDrawable(C0488R.drawable.msg_out).mutate();
            chat_msgInMediaDrawable = resources.getDrawable(C0488R.drawable.msg_photo).mutate();
            chat_msgInMediaSelectedDrawable = resources.getDrawable(C0488R.drawable.msg_photo).mutate();
            chat_msgOutMediaDrawable = resources.getDrawable(C0488R.drawable.msg_photo).mutate();
            chat_msgOutMediaSelectedDrawable = resources.getDrawable(C0488R.drawable.msg_photo).mutate();
            chat_msgOutCheckDrawable = resources.getDrawable(C0488R.drawable.msg_check).mutate();
            chat_msgOutCheckSelectedDrawable = resources.getDrawable(C0488R.drawable.msg_check).mutate();
            chat_msgMediaCheckDrawable = resources.getDrawable(C0488R.drawable.msg_check).mutate();
            chat_msgStickerCheckDrawable = resources.getDrawable(C0488R.drawable.msg_check).mutate();
            chat_msgOutHalfCheckDrawable = resources.getDrawable(C0488R.drawable.msg_halfcheck).mutate();
            chat_msgOutHalfCheckSelectedDrawable = resources.getDrawable(C0488R.drawable.msg_halfcheck).mutate();
            chat_msgMediaHalfCheckDrawable = resources.getDrawable(C0488R.drawable.msg_halfcheck).mutate();
            chat_msgStickerHalfCheckDrawable = resources.getDrawable(C0488R.drawable.msg_halfcheck).mutate();
            chat_msgOutClockDrawable = resources.getDrawable(C0488R.drawable.msg_clock).mutate();
            chat_msgOutSelectedClockDrawable = resources.getDrawable(C0488R.drawable.msg_clock).mutate();
            chat_msgInClockDrawable = resources.getDrawable(C0488R.drawable.msg_clock).mutate();
            chat_msgInSelectedClockDrawable = resources.getDrawable(C0488R.drawable.msg_clock).mutate();
            chat_msgMediaClockDrawable = resources.getDrawable(C0488R.drawable.msg_clock).mutate();
            chat_msgStickerClockDrawable = resources.getDrawable(C0488R.drawable.msg_clock).mutate();
            chat_msgInViewsDrawable = resources.getDrawable(C0488R.drawable.msg_views).mutate();
            chat_msgInViewsSelectedDrawable = resources.getDrawable(C0488R.drawable.msg_views).mutate();
            chat_msgOutViewsDrawable = resources.getDrawable(C0488R.drawable.msg_views).mutate();
            chat_msgOutViewsSelectedDrawable = resources.getDrawable(C0488R.drawable.msg_views).mutate();
            chat_msgMediaViewsDrawable = resources.getDrawable(C0488R.drawable.msg_views).mutate();
            chat_msgStickerViewsDrawable = resources.getDrawable(C0488R.drawable.msg_views).mutate();
            chat_msgInMenuDrawable = resources.getDrawable(C0488R.drawable.msg_actions).mutate();
            chat_msgInMenuSelectedDrawable = resources.getDrawable(C0488R.drawable.msg_actions).mutate();
            chat_msgOutMenuDrawable = resources.getDrawable(C0488R.drawable.msg_actions).mutate();
            chat_msgOutMenuSelectedDrawable = resources.getDrawable(C0488R.drawable.msg_actions).mutate();
            chat_msgMediaMenuDrawable = resources.getDrawable(C0488R.drawable.video_actions);
            chat_msgInInstantDrawable = resources.getDrawable(C0488R.drawable.msg_instant).mutate();
            chat_msgOutInstantDrawable = resources.getDrawable(C0488R.drawable.msg_instant).mutate();
            chat_msgErrorDrawable = resources.getDrawable(C0488R.drawable.msg_warning);
            chat_muteIconDrawable = resources.getDrawable(C0488R.drawable.list_mute).mutate();
            chat_lockIconDrawable = resources.getDrawable(C0488R.drawable.ic_lock_header);
            chat_msgBroadcastDrawable = resources.getDrawable(C0488R.drawable.broadcast3).mutate();
            chat_msgBroadcastMediaDrawable = resources.getDrawable(C0488R.drawable.broadcast3).mutate();
            chat_msgInCallDrawable = resources.getDrawable(C0488R.drawable.ic_call_white_24dp).mutate();
            chat_msgInCallSelectedDrawable = resources.getDrawable(C0488R.drawable.ic_call_white_24dp).mutate();
            chat_msgOutCallDrawable = resources.getDrawable(C0488R.drawable.ic_call_white_24dp).mutate();
            chat_msgOutCallSelectedDrawable = resources.getDrawable(C0488R.drawable.ic_call_white_24dp).mutate();
            chat_msgCallUpRedDrawable = resources.getDrawable(C0488R.drawable.ic_call_made_green_18dp).mutate();
            chat_msgCallUpGreenDrawable = resources.getDrawable(C0488R.drawable.ic_call_made_green_18dp).mutate();
            chat_msgCallDownRedDrawable = resources.getDrawable(C0488R.drawable.ic_call_received_green_18dp).mutate();
            chat_msgCallDownGreenDrawable = resources.getDrawable(C0488R.drawable.ic_call_received_green_18dp).mutate();
            chat_msgAvatarLiveLocationDrawable = resources.getDrawable(C0488R.drawable.livepin).mutate();
            chat_inlineResultFile = resources.getDrawable(C0488R.drawable.bot_file);
            chat_inlineResultAudio = resources.getDrawable(C0488R.drawable.bot_music);
            chat_inlineResultLocation = resources.getDrawable(C0488R.drawable.bot_location);
            chat_msgInShadowDrawable = resources.getDrawable(C0488R.drawable.msg_in_shadow);
            chat_msgOutShadowDrawable = resources.getDrawable(C0488R.drawable.msg_out_shadow);
            chat_msgInMediaShadowDrawable = resources.getDrawable(C0488R.drawable.msg_photo_shadow);
            chat_msgOutMediaShadowDrawable = resources.getDrawable(C0488R.drawable.msg_photo_shadow);
            chat_botLinkDrawalbe = resources.getDrawable(C0488R.drawable.bot_link);
            chat_botInlineDrawable = resources.getDrawable(C0488R.drawable.bot_lines);
            chat_systemDrawable = resources.getDrawable(C0488R.drawable.system);
            chat_contextResult_shadowUnderSwitchDrawable = resources.getDrawable(C0488R.drawable.header_shadow).mutate();
            chat_attachButtonDrawables[0] = resources.getDrawable(C0488R.drawable.attach_camera_states);
            chat_attachButtonDrawables[1] = resources.getDrawable(C0488R.drawable.attach_gallery_states);
            chat_attachButtonDrawables[2] = resources.getDrawable(C0488R.drawable.attach_video_states);
            chat_attachButtonDrawables[3] = resources.getDrawable(C0488R.drawable.attach_audio_states);
            chat_attachButtonDrawables[4] = resources.getDrawable(C0488R.drawable.attach_file_states);
            chat_attachButtonDrawables[5] = resources.getDrawable(C0488R.drawable.attach_contact_states);
            chat_attachButtonDrawables[6] = resources.getDrawable(C0488R.drawable.attach_location_states);
            chat_attachButtonDrawables[7] = resources.getDrawable(C0488R.drawable.attach_hide_states);
            chat_cornerOuter[0] = resources.getDrawable(C0488R.drawable.corner_out_tl);
            chat_cornerOuter[1] = resources.getDrawable(C0488R.drawable.corner_out_tr);
            chat_cornerOuter[2] = resources.getDrawable(C0488R.drawable.corner_out_br);
            chat_cornerOuter[3] = resources.getDrawable(C0488R.drawable.corner_out_bl);
            chat_cornerInner[0] = resources.getDrawable(C0488R.drawable.corner_in_tr);
            chat_cornerInner[1] = resources.getDrawable(C0488R.drawable.corner_in_tl);
            chat_cornerInner[2] = resources.getDrawable(C0488R.drawable.corner_in_br);
            chat_cornerInner[3] = resources.getDrawable(C0488R.drawable.corner_in_bl);
            chat_shareDrawable = resources.getDrawable(C0488R.drawable.share_round);
            chat_shareIconDrawable = resources.getDrawable(C0488R.drawable.share_arrow);
            chat_replyIconDrawable = resources.getDrawable(C0488R.drawable.fast_reply);
            chat_goIconDrawable = resources.getDrawable(C0488R.drawable.message_arrow);
            chat_ivStatesDrawable[0][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(40.0f), (int) C0488R.drawable.msg_round_play_m, 1);
            chat_ivStatesDrawable[0][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(40.0f), (int) C0488R.drawable.msg_round_play_m, 1);
            chat_ivStatesDrawable[1][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(40.0f), (int) C0488R.drawable.msg_round_pause_m, 1);
            chat_ivStatesDrawable[1][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(40.0f), (int) C0488R.drawable.msg_round_pause_m, 1);
            chat_ivStatesDrawable[2][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(40.0f), (int) C0488R.drawable.msg_round_load_m, 1);
            chat_ivStatesDrawable[2][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(40.0f), (int) C0488R.drawable.msg_round_load_m, 1);
            chat_ivStatesDrawable[3][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(40.0f), (int) C0488R.drawable.msg_round_cancel_m, 2);
            chat_ivStatesDrawable[3][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(40.0f), (int) C0488R.drawable.msg_round_cancel_m, 2);
            chat_fileMiniStatesDrawable[0][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[0][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[1][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[1][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[2][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[2][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.audio_mini_arrow);
            chat_fileMiniStatesDrawable[3][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[3][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.audio_mini_cancel);
            chat_fileMiniStatesDrawable[4][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.video_mini_arrow);
            chat_fileMiniStatesDrawable[4][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.video_mini_arrow);
            chat_fileMiniStatesDrawable[5][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.video_mini_cancel);
            chat_fileMiniStatesDrawable[5][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(22.0f), C0488R.drawable.video_mini_cancel);
            chat_fileStatesDrawable[0][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[0][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[1][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[1][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[2][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[2][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[3][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[3][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[4][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_cancel_m);
            chat_fileStatesDrawable[4][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_cancel_m);
            chat_fileStatesDrawable[5][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[5][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_play_m);
            chat_fileStatesDrawable[6][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[6][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_pause_m);
            chat_fileStatesDrawable[7][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[7][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_load_m);
            chat_fileStatesDrawable[8][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[8][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_file_s);
            chat_fileStatesDrawable[9][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_cancel_m);
            chat_fileStatesDrawable[9][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[0][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[0][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[1][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[1][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[2][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_gif_m);
            chat_photoStatesDrawables[2][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_gif_m);
            chat_photoStatesDrawables[3][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_play_m);
            chat_photoStatesDrawables[3][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_play_m);
            Drawable[] drawableArr = chat_photoStatesDrawables[4];
            Drawable[] drawableArr2 = chat_photoStatesDrawables[4];
            Drawable drawable = resources.getDrawable(C0488R.drawable.burn);
            drawableArr2[1] = drawable;
            drawableArr[0] = drawable;
            drawableArr = chat_photoStatesDrawables[5];
            drawableArr2 = chat_photoStatesDrawables[5];
            drawable = resources.getDrawable(C0488R.drawable.circle);
            drawableArr2[1] = drawable;
            drawableArr[0] = drawable;
            drawableArr = chat_photoStatesDrawables[6];
            drawableArr2 = chat_photoStatesDrawables[6];
            drawable = resources.getDrawable(C0488R.drawable.photocheck);
            drawableArr2[1] = drawable;
            drawableArr[0] = drawable;
            chat_photoStatesDrawables[7][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[7][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[8][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[8][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[9][0] = resources.getDrawable(C0488R.drawable.doc_big).mutate();
            chat_photoStatesDrawables[9][1] = resources.getDrawable(C0488R.drawable.doc_big).mutate();
            chat_photoStatesDrawables[10][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[10][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_load_m);
            chat_photoStatesDrawables[11][0] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[11][1] = createCircleDrawableWithIcon(AndroidUtilities.dp(48.0f), C0488R.drawable.msg_round_cancel_m);
            chat_photoStatesDrawables[12][0] = resources.getDrawable(C0488R.drawable.doc_big).mutate();
            chat_photoStatesDrawables[12][1] = resources.getDrawable(C0488R.drawable.doc_big).mutate();
            chat_contactDrawable[0] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_contact);
            chat_contactDrawable[1] = createCircleDrawableWithIcon(AndroidUtilities.dp(44.0f), C0488R.drawable.msg_contact);
            chat_locationDrawable[0] = createRoundRectDrawableWithIcon(AndroidUtilities.dp(2.0f), C0488R.drawable.msg_location);
            chat_locationDrawable[1] = createRoundRectDrawableWithIcon(AndroidUtilities.dp(2.0f), C0488R.drawable.msg_location);
            chat_composeShadowDrawable = context.getResources().getDrawable(C0488R.drawable.compose_panel_shadow);
            try {
    ...
    public static void applyChatTheme(boolean fontsOnly) {
        if (chat_msgTextPaint != null && chat_msgInDrawable != null && !fontsOnly) {
            ...
            for (a = 0; a < 2; a++) {
                ...
                setCombinedDrawableColor(chat_fileMiniStatesDrawable[a + 2][0], getColor(key_chat_inBubble), true);
                setCombinedDrawableColor(chat_fileMiniStatesDrawable[a + 2][1], getColor(key_chat_inLoaderSelected), false);
                setCombinedDrawableColor(chat_fileMiniStatesDrawable[a + 2][1], getColor(key_chat_inBubbleSelected), true);
    ...
    public static void createProfileResources(Context context) {
        if (profile_verifiedDrawable == null) {
            ...
            Resources resources = context.getResources();
            profile_verifiedDrawable = resources.getDrawable(C0488R.drawable.verified_area).mutate();
            profile_verifiedCheckDrawable = resources.getDrawable(C0488R.drawable.verified_check).mutate();
            applyProfileTheme();
        }
                                    ...
                                    if (Theme.wallpaper == null) {
                                        ...
                                        if (i == 0) {
                                            if (selectedBackground == 1000001) {
                                                Theme.wallpaper = ApplicationLoader.applicationContext.getResources().getDrawable(C0488R.drawable.background_hd);
