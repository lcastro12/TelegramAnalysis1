...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    class C06191 implements OnGlobalLayoutListener {
        C06191() {
        }
    ...
    class C06224 implements Runnable {
        C06224() {
        }
    ...
    static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = new C06231();
        int currentPosition;

        static class C06231 implements Creator<SavedState> {
            C06231() {
            }
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.lastScrollX = 0;
        this.tabBackgroundResId = C0419R.drawable.background_tab;
        ...
        a.recycle();
        a = context.obtainStyledAttributes(attrs, C0419R.styleable.PagerSlidingTabStrip);
    ...
    public void notifyDataSetChanged() {
        ...
        updateTabStyles();
        this.checkedTabWidths = false;
        getViewTreeObserver().addOnGlobalLayoutListener(new C06191());
        updateExpanded();
    }
