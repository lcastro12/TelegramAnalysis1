...
public class SendMessagesHelper implements NotificationCenterDelegate {
            ...
            try {
                ...
                try {
                    if (BuildVars.LOGS_ENABLED && sendToPeer != null) {
                        FileLog.m0d("send message user_id = " + sendToPeer.user_id + " chat_id = " + sendToPeer.chat_id + " channel_id = " + sendToPeer.channel_id + " access_hash = " + sendToPeer.access_hash);
                    }
                    ...
                    if (type == 0 || !(type != 9 || message == null || encryptedChat == null)) {
                        ...
                        if (type == 1) {
                            ...
                            if (type == 2 || (type == 9 && photo != null)) {
                                ...
                                reqSend6.media.thumb_h = small.f24h;
                                reqSend6.media.thumb_w = small.f25w;
                                reqSend6.media.f16w = big.f25w;
                                reqSend6.media.f15h = big.f24h;
                                ...
                                for (a = 0; a < document2.attributes.size(); a++) {
                                    ...
                                    if (attribute instanceof TL_documentAttributeVideo) {
                                        reqSend6.media.f16w = attribute.f18w;
                                        reqSend6.media.f15h = attribute.f17h;
                                        reqSend6.media.duration = attribute.duration;
                                        break;
                                    }
                                }
                                reqSend6.media.thumb_h = document2.thumb.f24h;
                                reqSend6.media.thumb_w = document2.thumb.f25w;
    ...
    L_0x0356:
        r24 = move-exception;
        org.telegram.messenger.FileLog.m3e(r24);
        goto L_0x00c2;
    L_0x035c:
        r24 = move-exception;
    L_0x035d:
        org.telegram.messenger.FileLog.m3e(r24);	 Catch:{ all -> 0x036d }
