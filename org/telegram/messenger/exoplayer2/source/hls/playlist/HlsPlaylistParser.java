...
public final class HlsPlaylistParser implements Parser<HlsPlaylist> {
    ...
    private static HlsMediaPlaylist parseMediaPlaylist(LineIterator iterator, String baseUri) throws IOException {
        int playlistType = 0;
        long startOffsetUs = C0600C.TIME_UNSET;
        int mediaSequence = 0;
        int version = 1;
        long targetDurationUs = C0600C.TIME_UNSET;
        ...
        while (iterator.hasNext()) {
            ...
            if (line.startsWith(TAG_PLAYLIST_TYPE)) {
                ...
                targetDurationUs = ((long) parseIntAttr(line, REGEX_TARGET_DURATION)) * C0600C.MICROS_PER_SECOND;
                ...
                if (!METHOD_NONE.equals(method)) {
                    ...
                    if (KEYFORMAT_IDENTITY.equals(keyFormat) || keyFormat == null) {
                        ...
                        String str = (METHOD_SAMPLE_AES_CENC.equals(method) || METHOD_SAMPLE_AES_CTR.equals(method)) ? C0600C.CENC_TYPE_cenc : C0600C.CENC_TYPE_cbcs;
                ...
                if (playlistStartTimeUs == 0) {
                    playlistStartTimeUs = C0600C.msToUs(Util.parseXsDateTime(line.substring(line.indexOf(58) + 1))) - segmentStartTimeUs;
                }
