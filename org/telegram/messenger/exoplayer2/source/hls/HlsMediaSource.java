...
public final class HlsMediaSource implements MediaSource, PrimaryPlaylistListener {
    ...
    public void onPrimaryPlaylistRefreshed(HlsMediaPlaylist playlist) {
        ...
        long presentationStartTimeMs = playlist.hasProgramDateTime ? 0 : C0600C.TIME_UNSET;
        long windowStartTimeMs = playlist.hasProgramDateTime ? C0600C.usToMs(playlist.startTimeUs) : C0600C.TIME_UNSET;
        long windowDefaultStartPositionUs = playlist.startOffsetUs;
        if (this.playlistTracker.isLive()) {
            boolean z;
            long periodDurationUs = playlist.hasEndTag ? playlist.startTimeUs + playlist.durationUs : C0600C.TIME_UNSET;
            List<Segment> segments = playlist.segments;
            if (windowDefaultStartPositionUs == C0600C.TIME_UNSET) {
                if (segments.isEmpty()) {
