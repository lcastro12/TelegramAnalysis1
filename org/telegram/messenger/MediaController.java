...
public class MediaController implements SensorEventListener, OnAudioFocusChangeListener, NotificationCenterDelegate {
                        ...
                        if (MediaController.this.baseActivity != null) {
                            if (MediaController.this.pipRoundVideoView == null) {
                                try {
                                    ...
                                    MediaController.this.pipRoundVideoView.show(MediaController.this.baseActivity, new C02911());
                                } catch (Exception e) {
            ...
            public void run() {
                            ...
                            try {
                                ...
                                if (!(path == null || path.length() == 0)) {
                                    ...
                                    if (allPhotosAlbum == null) {
                                        albumEntry = new AlbumEntry(0, LocaleController.getString("AllPhotos", C0488R.string.AllPhotos), photoEntry2);
                                        try {
                                    ...
                                    if (allMediaAlbum == null) {
                                        albumEntry4 = new AlbumEntry(0, LocaleController.getString("AllMedia", C0488R.string.AllMedia), photoEntry2);
                                        try {
                ...
                if (cursor != null) {
                        ...
                        if (cursor != null) {
                            ...
                            while (cursor.moveToNext()) {
                                ...
                                if (!(path == null || path.length() == 0)) {
                                    ...
                                    if (allMediaAlbum != null) {
                                        albumEntry4 = new AlbumEntry(0, LocaleController.getString("AllMedia", C0488R.string.AllMedia), photoEntry);
                                        try {
                                            mediaAlbumsSorted.add(0, albumEntry4);
                                        } catch (Throwable th5) {
                                            th = th5;
                    ...
                    for (a = 0; a < mediaAlbumsSorted.size(); a++) {
                        Collections.sort(((AlbumEntry) mediaAlbumsSorted.get(a)).photos, new C03021());
                    }
    ...
    L_0x01da:
        r39 = move-exception;
    L_0x01db:
        org.telegram.messenger.FileLog.m3e(r39);	 Catch:{ Exception -> 0x0923, all -> 0x051d }
        r47 = 1;
    L_0x01e0:
        r0 = r50;
        r1 = r90;
    ...
    L_0x0212:
        ...
        r6 = r6.append(r10);
        r6 = r6.toString();
        org.telegram.messenger.FileLog.m0d(r6);
        r49 = r50;
    L_0x0231:
        r6 = r74.edit();
        r10 = "isPreviousOk";
    ...
    L_0x0286:
        ...
        org.telegram.messenger.FileLog.m0d(r6);	 Catch:{ Exception -> 0x01da, all -> 0x051d }
    L_0x02bb:
        r6 = org.telegram.messenger.BuildVars.LOGS_ENABLED;	 Catch:{ Exception -> 0x01da, all -> 0x051d }
    ...
    L_0x08a8:
        r39 = move-exception;
        r48 = 1;
        org.telegram.messenger.FileLog.m3e(r39);	 Catch:{ Exception -> 0x01da, all -> 0x051d }
        goto L_0x084a;
    L_0x08af:
        r10 = 2500; // 0x9c4 float:3.503E-42 double:1.235E-320;
        r0 = r41;
    ...
    L_0x0926:
        r47 = 1;
        org.telegram.messenger.FileLog.m3e(r39);	 Catch:{ all -> 0x0989 }
    ...
    L_0x095b:
        r39 = move-exception;
        org.telegram.messenger.FileLog.m3e(r39);
        goto L_0x020e;
    L_0x0961:
        r39 = move-exception;
        org.telegram.messenger.FileLog.m3e(r39);
