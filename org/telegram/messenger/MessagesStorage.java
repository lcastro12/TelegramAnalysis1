            ...
            public void run() {
                ...
                try {
                    ...
                    for (a = i; a < org_telegram_tgnet_TLRPC_messages_Dialogs.dialogs.size(); a++) {
                        orderArrayList.add(Long.valueOf(((TL_dialog) org_telegram_tgnet_TLRPC_messages_Dialogs.dialogs.get(a)).id));
                    }
                    ...
                    for (a = 0; a < totalPinnedCount; a++) {
                        TL_dialog dialog = (TL_dialog) org_telegram_tgnet_TLRPC_messages_Dialogs.dialogs.get(i + a);
...
*/
    ...
    public TLObject getSentFile(String path, int type) {
        ...
        this.storageQueue.postRunnable(new Runnable() {
            ...
            L_0x006b:
                r2 = move-exception;
                org.telegram.messenger.FileLog.m3e(r2);	 Catch:{ all -> 0x0075 }
                r5 = r5;
                r5.countDown();
                goto L_0x005c;
            L_0x0075:
    ...
    public void getEncryptedChat(final int chat_id, final CountDownLatch countDownLatch, final ArrayList<TLObject> result) {
        if (countDownLatch != null && result != null) {
            this.storageQueue.postRunnable(new Runnable() {
                ...
                L_0x0062:
                    r0 = move-exception;
                    org.telegram.messenger.FileLog.m3e(r0);	 Catch:{ all -> 0x006c }
                    r4 = r4;
                    r4.countDown();
                    goto L_0x0061;
                L_0x006c:
