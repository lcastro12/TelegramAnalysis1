...
public class HttpURLConnectionBuilder {
    ...
    public HttpURLConnectionBuilder writeFormFields(Map<String, String> fields) {
        ...
        try {
            String formString = getFormString(fields, C0600C.UTF8_NAME);
    ...
    public HttpURLConnection build() throws IOException {
        ...
        if (!TextUtils.isEmpty(this.mRequestBody)) {
            BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(connection.getOutputStream(), C0600C.UTF8_NAME));
