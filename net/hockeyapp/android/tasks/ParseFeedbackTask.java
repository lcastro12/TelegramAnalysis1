...
public class ParseFeedbackTask extends AsyncTask<Void, Void, FeedbackResponse> {
    ...
    private static void showNewAnswerNotification(Context context, String urlString) {
        ...
        Util.sendNotification(context, 2, Util.createNotification(context, PendingIntent.getActivity(context, 0, intent, 1073741824), context.getString(C0051R.string.hockeyapp_feedback_notification_title), context.getString(C0051R.string.hockeyapp_feedback_new_answer_notification_message), iconId, "net.hockeyapp.android.NOTIFICATION"), "net.hockeyapp.android.NOTIFICATION", context.getString(C0051R.string.hockeyapp_feedback_notification_channel));
    }
}
