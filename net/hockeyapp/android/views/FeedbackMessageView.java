...
public class FeedbackMessageView extends LinearLayout {
    private AttachmentListView mAttachmentListView = ((AttachmentListView) findViewById(C0051R.id.list_attachments));
    private TextView mAuthorTextView = ((TextView) findViewById(C0051R.id.label_author));
    private final Context mContext;
    private TextView mDateTextView = ((TextView) findViewById(C0051R.id.label_date));
    private TextView mMessageTextView = ((TextView) findViewById(C0051R.id.label_text));

    public FeedbackMessageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        LayoutInflater.from(context).inflate(C0051R.layout.hockeyapp_view_feedback_message, this);
    }
    ...
    public void setIndex(int index) {
        if (index % 2 == 0) {
            setBackgroundColor(getResources().getColor(C0051R.color.hockeyapp_background_light));
        } else {
            setBackgroundColor(getResources().getColor(C0051R.color.hockeyapp_background_white));
        }
    }
}
