...
public interface C0240d extends IInterface {

    public static abstract class C0833a extends Binder implements C0240d {

        private static class C0832a implements C0240d {
            private IBinder dG;
            ...
            public boolean mo1267h(C0240d c0240d) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            public void mo1270i(C0112b c0112b) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IMarkerDelegate");
        ...
        public static C0240d af(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0240d)) ? new C0832a(iBinder) : (C0240d) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 16:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    isDraggable = mo1267h(C0833a.af(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isDraggable) {
                        i = 1;
                    }
                ...
                case 18:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    mo1270i(C0655a.m828z(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
    ...
    boolean mo1267h(C0240d c0240d) throws RemoteException;

    int hashCodeRemote() throws RemoteException;

    void hideInfoWindow() throws RemoteException;

    void mo1270i(C0112b c0112b) throws RemoteException;
