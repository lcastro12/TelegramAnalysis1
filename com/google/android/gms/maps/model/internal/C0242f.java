...
public interface C0242f extends IInterface {

    public static abstract class C0837a extends Binder implements C0242f {

        private static class C0836a implements C0242f {
            private IBinder dG;
            ...
            public boolean mo1307a(C0242f c0242f) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    obtain.writeStrongBinder(c0242f != null ? c0242f.asBinder() : null);
        ...
        public static C0242f ai(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0242f)) ? new C0836a(iBinder) : (C0242f) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    isVisible = mo1307a(C0837a.ai(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
    ...
    boolean mo1307a(C0242f c0242f) throws RemoteException;
