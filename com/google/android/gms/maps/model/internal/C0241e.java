...
public interface C0241e extends IInterface {

    public static abstract class C0835a extends Binder implements C0241e {

        private static class C0834a implements C0241e {
            private IBinder dG;
            ...
            public boolean mo1287a(C0241e c0241e) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    obtain.writeStrongBinder(c0241e != null ? c0241e.asBinder() : null);
        ...
        public static C0241e ag(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0241e)) ? new C0834a(iBinder) : (C0241e) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN /*19*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    isVisible = mo1287a(C0835a.ag(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
    ...
    boolean mo1287a(C0241e c0241e) throws RemoteException;
