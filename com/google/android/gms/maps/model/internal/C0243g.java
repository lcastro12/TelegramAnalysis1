...
public interface C0243g extends IInterface {

    public static abstract class C0839a extends Binder implements C0243g {

        private static class C0838a implements C0243g {
            private IBinder dG;
        ...
        public static C0243g aj(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.ITileProviderDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0243g)) ? new C0838a(iBinder) : (C0243g) queryLocalInterface;
        }
