...
public interface C0211b extends IInterface {

    public static abstract class C0796a extends Binder implements C0211b {

        private static class C0795a implements C0211b {
            private IBinder dG;
        ...
        public static C0211b m1260I(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ICancelableCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0211b)) ? new C0795a(iBinder) : (C0211b) queryLocalInterface;
        }
