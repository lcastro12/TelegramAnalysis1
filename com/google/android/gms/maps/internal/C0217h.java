...
public interface C0217h extends IInterface {

    public static abstract class C0808a extends Binder implements C0217h {

        private static class C0807a implements C0217h {
            private IBinder dG;
        ...
        public static C0217h m1274S(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0217h)) ? new C0807a(iBinder) : (C0217h) queryLocalInterface;
        }
