...
public interface C0222m extends IInterface {

    public static abstract class C0818a extends Binder implements C0222m {

        private static class C0817a implements C0222m {
            private IBinder dG;
        ...
        public static C0222m m1283X(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0222m)) ? new C0817a(iBinder) : (C0222m) queryLocalInterface;
        }
