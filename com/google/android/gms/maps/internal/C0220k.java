...
public interface C0220k extends IInterface {

    public static abstract class C0814a extends Binder implements C0220k {

        private static class C0813a implements C0220k {
            private IBinder dG;

            C0813a(IBinder iBinder) {
                this.dG = iBinder;
            }

            public boolean mo1190a(C0240d c0240d) throws RemoteException {
                boolean z = true;
        ...
        public static C0220k m1278V(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMarkerClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0220k)) ? new C0813a(iBinder) : (C0220k) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    boolean a = mo1190a(C0833a.af(data.readStrongBinder()));
    ...
    boolean mo1190a(C0240d c0240d) throws RemoteException;
}
