...
public interface C0219j extends IInterface {

    public static abstract class C0812a extends Binder implements C0219j {

        private static class C0811a implements C0219j {
            private IBinder dG;
        ...
        public static C0219j m1276U(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapLongClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0219j)) ? new C0811a(iBinder) : (C0219j) queryLocalInterface;
        }
