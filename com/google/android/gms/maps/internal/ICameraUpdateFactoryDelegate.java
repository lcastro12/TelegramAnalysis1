...
public interface ICameraUpdateFactoryDelegate extends IInterface {
    ...
    public static abstract class C0782a extends Binder implements ICameraUpdateFactoryDelegate {

        private static class C0781a implements ICameraUpdateFactoryDelegate {
            private IBinder dG;
            ...
            public C0112b newCameraPosition(CameraPosition cameraPosition) throws RemoteException {
            ...
            public C0112b newLatLng(LatLng latLng) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C0112b newLatLngBounds(LatLngBounds bounds, int padding) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C0112b newLatLngBoundsWithSize(LatLngBounds bounds, int width, int height, int padding) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C0112b newLatLngZoom(LatLng latLng, float zoom) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C0112b scrollBy(float xPixel, float yPixel) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C0112b zoomBy(float amount) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C0112b zoomByWithFocus(float amount, int screenFocusX, int screenFocusY) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C0112b zoomIn() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C0112b zoomOut() throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C0112b zoomTo(float zoom) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
        ...
        public static ICameraUpdateFactoryDelegate m1254H(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ICameraUpdateFactoryDelegate)) ? new C0781a(iBinder) : (ICameraUpdateFactoryDelegate) queryLocalInterface;
        }
    ...
    C0112b newCameraPosition(CameraPosition cameraPosition) throws RemoteException;

    C0112b newLatLng(LatLng latLng) throws RemoteException;

    C0112b newLatLngBounds(LatLngBounds latLngBounds, int i) throws RemoteException;

    C0112b newLatLngBoundsWithSize(LatLngBounds latLngBounds, int i, int i2, int i3) throws RemoteException;

    C0112b newLatLngZoom(LatLng latLng, float f) throws RemoteException;

    C0112b scrollBy(float f, float f2) throws RemoteException;

    C0112b zoomBy(float f) throws RemoteException;

    C0112b zoomByWithFocus(float f, int i, int i2) throws RemoteException;

    C0112b zoomIn() throws RemoteException;

    C0112b zoomOut() throws RemoteException;

    C0112b zoomTo(float f) throws RemoteException;
}
