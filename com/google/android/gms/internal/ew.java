...
public interface ew extends IInterface {
    ...
    public static abstract class C0739a extends Binder implements ew {

        private static class C0738a implements ew {
            private IBinder dG;
        ...
        public static ew m1169E(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ew)) ? new C0738a(iBinder) : (ew) queryLocalInterface;
        }
