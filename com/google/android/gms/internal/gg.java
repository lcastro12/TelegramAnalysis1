...
import com.google.android.gms.internal.fv.C0190e;
...
public final class gg extends C0096b implements Person {
    public gg(C0646d c0646d, int i) {
        super(c0646d, i);
    }
    ...
    public Person ea() {
        return new fv(getDisplayName(), getId(), (C0928c) getImage(), getObjectType(), getUrl());
    }
    ...
    public Image getImage() {
        return new C0928c(getString("image"));
    }
    ...
    public int getObjectType() {
        return C0190e.aa(getString("objectType"));
    }
