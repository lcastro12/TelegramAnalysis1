...
public interface bo extends IInterface {
    ...
    public static abstract class C0702a extends Binder implements bo {

        private static class C0701a implements bo {
            private IBinder dG;
            ...
            public IBinder mo808a(C0112b c0112b) throws RemoteException {
        ...
        public static bo m907n(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.overlay.client.IAdOverlayCreator");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bo)) ? new C0701a(iBinder) : (bo) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder a = mo808a(C0655a.m828z(data.readStrongBinder()));
    ...
    IBinder mo808a(C0112b c0112b) throws RemoteException;
}
