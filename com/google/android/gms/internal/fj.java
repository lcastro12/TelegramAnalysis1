...
public interface fj extends IInterface {
    ...
    public static abstract class C0756a extends Binder implements fj {

        private static class C0755a implements fj {
            private IBinder dG;
        ...
        public static fj ap(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof fj)) ? new C0755a(iBinder) : (fj) queryLocalInterface;
        }
