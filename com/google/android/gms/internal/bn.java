...
public interface bn extends IInterface {
    ...
    public static abstract class C0700a extends Binder implements bn {

        private static class C0699a implements bn {
            private IBinder dG;
        ...
        public static bn m905m(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.overlay.client.IAdOverlay");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bn)) ? new C0699a(iBinder) : (bn) queryLocalInterface;
        }
