...
public interface fe extends IInterface {
    ...
    public static abstract class C0748a extends Binder implements fe {

        private static class C0747a implements fe {
            private IBinder dG;
            ...
            public void mo1015a(fd fdVar, Uri uri, Bundle bundle, boolean z) throws RemoteException {
        ...
        public static fe al(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof fe)) ? new C0747a(iBinder) : (fe) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    mo1015a(C0746a.ak(data.readStrongBinder()), data.readInt() != 0 ? (Uri) Uri.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt() != 0);
                    return true;
                case 1598968902:
    ...
    void mo1015a(fd fdVar, Uri uri, Bundle bundle, boolean z) throws RemoteException;
}
