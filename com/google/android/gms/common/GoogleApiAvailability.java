        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C0022R.drawable.common_full_open_on_phone, resources.getString(C0022R.string.common_open_on_phone), pendingIntent);
                } else {
