...
import com.google.android.gms.base.C0022R;
...
public final class ConnectionErrorMessages {
    ...
    public static String getDefaultNotificationChannelName(Context context) {
        return context.getResources().getString(C0022R.string.common_google_play_services_notification_channel_name);
    }
    ...
    public static String getErrorDialogButtonMessage(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0022R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0022R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0022R.string.common_google_play_services_enable_button);
            default:
    ...
    public static String getErrorMessage(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0022R.string.common_google_play_services_install_text, new Object[]{appName});
            case 2:
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    return resources.getString(C0022R.string.common_google_play_services_wear_update_text);
                }
                return resources.getString(C0022R.string.common_google_play_services_update_text, new Object[]{appName});
            case 3:
                return resources.getString(C0022R.string.common_google_play_services_enable_text, new Object[]{appName});
            case 5:
            ...
            case 9:
                return resources.getString(C0022R.string.common_google_play_services_unsupported_text, new Object[]{appName});
            case 16:
            ...
            case 18:
                return resources.getString(C0022R.string.common_google_play_services_updating_text, new Object[]{appName});
            case 20:
                return zza(context, "common_google_play_services_restricted_profile_text", appName);
            default:
                return resources.getString(C0023R.string.common_google_play_services_unknown_issue, new Object[]{appName});
        }
    }
    ...
    public static String getErrorNotificationTitle(Context context, int i) {
        ...
        return zzb == null ? context.getResources().getString(C0022R.string.common_google_play_services_notification_ticker) : zzb;
    }
    ...
    public static String getErrorTitle(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0022R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C0022R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C0022R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    private static String zza(Context context, String str, String str2) {
        ...
        if (zzb == null) {
            zzb = resources.getString(C0023R.string.common_google_play_services_unknown_issue);
        }
