...
public final class GooglePlayServicesUtil {
    ...
    public static Dialog m24a(int i, Activity activity, int i2, OnCancelListener onCancelListener, int i3) {
        ...
        switch (i) {
            case 0:
                return null;
            case 1:
                return message.setTitle(C0090R.string.common_google_play_services_install_title).create();
            case 2:
                return message.setTitle(C0090R.string.common_google_play_services_update_title).create();
            case 3:
                return message.setTitle(C0090R.string.common_google_play_services_enable_title).create();
            case 4:
            case 6:
                return message.setTitle(C0090R.string.common_google_play_services_unknown_issue).create();
            case 5:
                Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                return message.setTitle(C0090R.string.common_google_play_services_invalid_account_title).create();
            case 7:
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return message.setTitle(C0090R.string.common_google_play_services_network_error_title).create();
            case 8:
                Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                return message.setTitle(C0090R.string.common_google_play_services_unknown_issue).create();
            case 9:
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return message.setTitle(C0090R.string.common_google_play_services_unsupported_title).create();
            case 10:
    ...
    public static String m29b(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0090R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0090R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0090R.string.common_google_play_services_enable_button);
            default:
    ...
    public static String m30b(Context context, int i, int i2) {
        ...
        switch (i) {
            case 1:
                string = m26a(context.getResources()) ? resources.getString(C0090R.string.common_google_play_services_install_text_tablet) : resources.getString(C0090R.string.common_google_play_services_install_text_phone);
                return m34n(i2) ? string + " (via Bazaar)" : string;
            case 2:
                string = resources.getString(C0090R.string.common_google_play_services_update_text);
                return m34n(i2) ? string + " (via Bazaar)" : string;
            case 3:
                return resources.getString(C0090R.string.common_google_play_services_enable_text);
            case 5:
                return resources.getString(C0090R.string.common_google_play_services_invalid_account_text);
            case 7:
                return resources.getString(C0090R.string.common_google_play_services_network_error_text);
            case 9:
                return resources.getString(C0090R.string.common_google_play_services_unsupported_text);
            case 12:
                return resources.getString(C0090R.string.common_google_play_services_unsupported_date_text);
            default:
                return resources.getString(C0090R.string.common_google_play_services_unknown_issue);
        }
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0090R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
