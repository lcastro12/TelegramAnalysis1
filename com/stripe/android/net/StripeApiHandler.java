...
*/
    ...
    static Map<String, String> getHeaders(RequestOptions options) {
        ...
        headers.put("Accept-Charset", C0600C.UTF8_NAME);
    ...
    private static HttpURLConnection createPostConnection(String url, String query, RequestOptions options) throws IOException {
        ...
        conn.setRequestProperty("Content-Type", String.format("application/x-www-form-urlencoded;charset=%s", new Object[]{C0600C.UTF8_NAME}));
        OutputStream outputStream = null;
        try {
            outputStream = conn.getOutputStream();
            outputStream.write(query.getBytes(C0600C.UTF8_NAME));
            return conn;
        } finally {
    ...
    private static String urlEncode(String str) throws UnsupportedEncodingException {
        ...
        return URLEncoder.encode(str, C0600C.UTF8_NAME);
    }
    ...
    private static String getResponseBody(InputStream responseStream) throws IOException {
        String rBody = new Scanner(responseStream, C0600C.UTF8_NAME).useDelimiter("\\A").next();
